...
import org.digibytej.utils.ListenerRegistration;
...
public class BasicKeyChain implements EncryptableKeyChain {
     ...
     * @throws org.digibytej.wallet.UnreadableWalletException.BadPassword if the password doesn't seem to match
     * @throws org.digibytej.wallet.UnreadableWalletException if the data structures are corrupted/inconsistent
     */
