...
public class KeyChainGroup implements KeyBag {
     ...
     * @see org.digibytej.wallet.MarriedKeyChain
     */
     ...
     *
     * @throws org.digibytej.crypto.KeyCrypterException Thrown if the wallet encryption fails for some reason,
     ...
     *
     * @throws org.digibytej.crypto.KeyCrypterException Thrown if the wallet decryption fails for some reason, leaving the group unchanged.
     */
