...
import org.digibytej.core.Monetary;
...
public final class MonetaryFormat {
    ...
    public static final MonetaryFormat DGB = new MonetaryFormat().shift(0).minDecimals(2).repeatOptionalDecimals(2, 3);
    /** Standard format for the mBTC denomination. */
    public static final MonetaryFormat MDGB = new MonetaryFormat().shift(3).minDecimals(2).optionalDecimals(2);
    /** Standard format for the µBTC denomination. */
    public static final MonetaryFormat UDGB = new MonetaryFormat().shift(6).minDecimals(0).optionalDecimals(2);
    ...
    public static final String CODE_UDGB = "µDGB";
    /** Currency symbol for base 1 Bitcoin. */
    public static final String SYMBOL_DGB = "\u20bf";
    /** Currency symbol for base 1/1000 Bitcoin. */
    public static final String SYMBOL_MDGB = "m" + SYMBOL_DGB;
    /** Currency symbol for base 1/1000000 Bitcoin. */
    public static final String SYMBOL_UDGB = "µ" + SYMBOL_DGB;
    ...
    public MonetaryFormat(boolean useBitcoinSymbol) {
        ...
        this.codes[0] = useBitcoinSymbol ? SYMBOL_DGB : CODE_DGB;
        this.codes[3] = useBitcoinSymbol ? SYMBOL_MDGB : CODE_MDGB;
        this.codes[6] = useBitcoinSymbol ? SYMBOL_UDGB : CODE_UDGB;
        this.codeSeparator = ' ';
