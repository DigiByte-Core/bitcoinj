...
import co.digibyte.crypto.Groestl;
import co.digibyte.crypto.Qubit;
import co.digibyte.crypto.Skein;
import co.digibyte.crypto.X11;

import static com.google.common.base.Preconditions.checkState;
import static org.digibytej.core.Coin.*;
import static org.digibytej.core.Sha256Hash.*;
import static org.digibytej.core.Utils.scryptDigest;
...
public class Block extends Message {
    ...
    private Sha256Hash calculateScryptHash() {
        try {
            ByteArrayOutputStream bos = new UnsafeByteArrayOutputStream(HEADER_SIZE);
            writeHeader(bos);
            return Sha256Hash.wrap(Utils.reverseBytes(scryptDigest(bos.toByteArray())));
        } catch (IOException e) {
            throw new RuntimeException(e); // Cannot happen.
        }
    }
    ...
    private Sha256Hash calculateGroestlHash() {
        try {
            ByteArrayOutputStream bos = new UnsafeByteArrayOutputStream(HEADER_SIZE);
            writeHeader(bos);
            return Sha256Hash.wrap(Utils.reverseBytes(Groestl.digest(bos.toByteArray())));
        } catch (IOException e) {
            throw new RuntimeException(e); // Cannot happen.
        }
    }
    ...
    private Sha256Hash calculateSkeinHash() {
        try {
            ByteArrayOutputStream bos = new UnsafeByteArrayOutputStream(HEADER_SIZE);
            writeHeader(bos);
            return Sha256Hash.wrap(Utils.reverseBytes(Skein.digest(bos.toByteArray())));
        } catch (IOException e) {
            throw new RuntimeException(e); // Cannot happen.
        }
    }
    ...
    private Sha256Hash calculateQubitHash() {
        try {
            ByteArrayOutputStream bos = new UnsafeByteArrayOutputStream(HEADER_SIZE);
            writeHeader(bos);
            return Sha256Hash.wrap(Utils.reverseBytes(Qubit.digest(bos.toByteArray())));
        } catch (IOException e) {
            throw new RuntimeException(e); // Cannot happen.
        }
    }		
