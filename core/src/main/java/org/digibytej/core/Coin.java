...
public final class Coin implements Monetary, Comparable<Coin>, Serializable {
    ...
    private static final MonetaryFormat FRIENDLY_FORMAT = MonetaryFormat.DGB.minDecimals(2).repeatOptionalDecimals(1, 6).postfixCode();
    ...
    private static final MonetaryFormat PLAIN_FORMAT = MonetaryFormat.DGB.minDecimals(0).repeatOptionalDecimals(1, 8).noCode();
