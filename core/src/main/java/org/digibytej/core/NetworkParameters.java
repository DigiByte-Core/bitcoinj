...
import org.digibytej.utils.VersionTally;
...
public abstract class NetworkParameters {
    ...
    /** Unit test network. */
    public static final String ID_UNITTESTNET = "org.digibytej.unittest";
    ...
    private static Block createGenesis(NetworkParameters n) {
        ...
        try {
            ...
            t.addOutput(new TransactionOutput(n, t, Coin.valueOf(8000, 0), scriptPubKeyBytes.toByteArray()));
        } catch (Exception e) {
            // Cannot happen.
            throw new RuntimeException(e);
        }
        genesisBlock.addTransaction(t);
        genesisBlock.setMerkleRoot(Sha256Hash.wrap("72ddd9496b004221ed0557358846d9248ecd4c440ebd28ed901efc18757d0fad"));
        return genesisBlock;
    }
     ...
     */
    public static final long MAX_COINS = 210000000;
