...
public class CheckpointManagerTest {
    ...
    public void shouldThrowNullPointerExceptionWhenCheckpointsNotFound() throws IOException {
        expect(params.getId()).andReturn("org/digibytej/core/checkpointmanagertest/notFound");
        replay(params);
    ...
    public void shouldThrowNullPointerExceptionWhenCheckpointsInUnknownFormat() throws IOException {
        expect(params.getId()).andReturn("org/digibytej/core/checkpointmanagertest/unsupportedFormat");
        replay(params);
        new CheckpointManager(params, null);
    }
    ...
    public void shouldThrowIllegalStateExceptionWithNoCheckpoints() throws IOException {
        expect(params.getId()).andReturn("org/digibytej/core/checkpointmanagertest/noCheckpoints");
        replay(params);
        new CheckpointManager(params, null);
    }
    ...
    public void canReadTextualStream() throws IOException {
        expect(params.getId()).andReturn("org/digibytej/core/checkpointmanagertest/validTextualFormat");
